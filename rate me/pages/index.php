...
<body>
  ...
  <header>
    <div class="container">
      <div class="menu-bar">
        <ul>
          <li class="active"><a href="../pages/index.php">الصفحة الرئيسية</a></li>
  ...
  <section>
    ...
    <div class="container" style="text-align: center; ">
      <div class="row align-items-start">
        <div class="col">
          <a href="../pages/zwz.php"><img src="../img/re1/zwz.png" alt="" class="border border-5 border border-dark"></a>
          <h5>زعتر وزيت</h5>
        </div>
        <div class="col">
