...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM user WHERE uname='$username' OR phone_number='$phone' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO user (uname, phone_number, Password) 
...
if (isset($_POST['login_user'])) {
    ...
    if (count($errors) == 0) {
        ...
        $query = "SELECT * FROM user WHERE phone_number='$phone' AND Password='$password'";
