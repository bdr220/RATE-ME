...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2021 at 08:09 PM
...
--
-- Table structure for table `sig_store`
--

CREATE TABLE `sig_store` (
...
--
-- Table structure for table `sig_user`
--

CREATE TABLE `sig_user` (
